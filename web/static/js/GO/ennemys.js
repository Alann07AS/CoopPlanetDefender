...
export const GreenEnnemyGameObjectInfo = new GOinfo()
    ...
    GreenEnnemyGameObjectInfo.spritesAnimation.set("death1", new SpriteAnimation("death1", "./static/assets/greenenemysdeath1.png", 35, 32, 6, 3));
...
export const YellowEnnemyGameObjectInfo = new GOinfo()
    ...
    YellowEnnemyGameObjectInfo.spritesAnimation.set("death1", new SpriteAnimation("death1", "./static/assets/yelowenemysdeath1.png", 35, 32, 6, 3));
